...
export function TrustDialog(t0) {
  ...
  if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
    t19 = <Text dimColor={true}>Use somente em workspaces confiáveis.</Text>;
    $[23] = t19;
  } else {
    t19 = $[23];
  }
  ...
  if ($[27] !== exitState.keyName || $[28] !== exitState.pending) {
    t22 = <Text dimColor={true}>{exitState.pending ? <>Pressione {exitState.keyName} novamente para sair</> : <>Enter para confirmar · Esc para cancelar</>}</Text>;
  ...
  let t23;
  if ($[30] !== t21 || $[31] !== t22) {
    t23 = <PermissionDialog color="warning" titleColor="warning" title="Acessando workspace:"><Box flexDirection="column" gap={1} paddingTop={1}>{t16}{t17}{t18}{t19}{t21}{t22}</Box></PermissionDialog>;
    $[30] = t21;
    $[31] = t22;
    $[32] = t23;
  } else {
