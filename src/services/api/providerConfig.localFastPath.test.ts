...
const ENV_VAR = 'LYACODE_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('LYACODE_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('LYACODE_LOCAL_FAST_PATH=0 forces off against localhost', () => {
