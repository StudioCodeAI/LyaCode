...
const ENV_VAR = 'LYACLOUD_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('LYACLOUD_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('LYACLOUD_LOCAL_FAST_PATH=0 forces off against localhost', () => {
