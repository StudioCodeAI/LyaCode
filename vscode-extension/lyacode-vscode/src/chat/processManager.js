/**
 * ProcessManager — spawns Lya Code in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The lyacode binary (e.g. 'lyacode')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'lyacode';
