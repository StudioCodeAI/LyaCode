; IExpress SED file for Lya Cloud Windows Installer
; Luis Cardozo · studiocoder.ai@gmail.com · Studio CodeAI
;
; Build:
;   iexpress /N:scripts\installer\windows\lyacloud-setup-x64.sed /O:dist\installer\lyacloud-setup-x64-0.1.0.exe
;
...
CAB_ReserveCode=0
RebootMode=N
InstallPrompt=Instalar Lya Cloud — CLI agentic da familia Studio CodeAI
DisplayLicense=scripts\installer\windows\LICENSE.rtf
FinishMessage=Lya Cloud instalado com sucesso.
TargetName=%TEMP%\lyacloud-setup
FriendlyName=Lya Cloud Setup
AppLaunched=cmd.exe /c powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%TEMP%\lyacloud-setup\install.ps1"
PostInstallCmd=<None>
[SourceFiles]
...
SourceFiles0=studiocodeai-lyacloud-0.1.0.tgz
