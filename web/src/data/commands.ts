...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the Lya Code project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage Lya Code plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up Lya Code's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order Lya Code stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your Lya Code installation and settings', category: 'diagnostics' },
  { name: 'stats', description: 'Show your usage statistics and activity', category: 'diagnostics' },
  { name: 'insights', description: 'Generate a report analyzing your Lya Code sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about Lya Code', category: 'diagnostics', args: '[report]' },
]
