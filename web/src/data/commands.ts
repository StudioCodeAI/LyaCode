...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the Lya Cloud project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage Lya Cloud plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up Lya Cloud's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order Lya Cloud stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your Lya Cloud installation and settings', category: 'diagnostics' },
  { name: 'stats', description: 'Show your usage statistics and activity', category: 'diagnostics' },
  { name: 'insights', description: 'Generate a report analyzing your Lya Cloud sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about Lya Cloud', category: 'diagnostics', args: '[report]' },
]
